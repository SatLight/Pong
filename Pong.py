...
bxin=0 #initial position of the player handle on the x axis
byin=1 #initial position of the player handle on the y axis
r=10 #radius of the ball
p1w=0
p2w=0
#width = 800 , height = 600

screen = pygame.display.set_mode((WIDTH,HEIGHT)) #sets the screen of given WIDTH and HEIGHT
pygame.display.set_caption('PONG!!') #displays on the title bar
font = pygame.font.Font(None, 36) #initializes the font
gameIcon = pygame.image.load('Pong_Icon.png') #loads the game icon; doesn't display it
pygame.display.set_icon(gameIcon) #displays the game icon

pause=False #pauses the game if the value is True
